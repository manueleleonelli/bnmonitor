...
We can construct a standard perturbation matrix as well as model-preserving covariation matrices using the following commands. The standard perturbation acts additively by a factor of ten, whilst for model-preserving matrices we apply the same factor (which now acts multiplicatively).
